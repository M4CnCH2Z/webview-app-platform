...
public class Member extends BaseTimeEntity {
    ...
    public static Member create(MemberSignupRequest memberSignupRequest, PasswordEncoder passwordEncoder) {
        return Member.builder()
                ...
                .zipcode(memberSignupRequest.getZipcode() == null ? "" : memberSignupRequest.getZipcode())
                .detailAddress(memberSignupRequest.getDetailAddress() == null ? "" : memberSignupRequest.getDetailAddress())
